...
jazzy::GraphicsPipelineLayout::GraphicsPipelineLayout(const GraphicsPipelineLayoutDesc& desc, const GraphicsResourceDesc& gDesc):
...
jazzy::BinaryData jazzy::GraphicsPipelineLayout::getVSBinaryData() const noexcept
{
	return m_vsBinary->getData();
}

jazzy::BinaryData jazzy::GraphicsPipelineLayout::getPSBinaryData() const noexcept
{
	return m_psBinary->getData();
}

jazzy::BinaryData jazzy::GraphicsPipelineLayout::getInputElementsData() const noexcept
{
	return
	{
		m_elements,
...
void jazzy::GraphicsPipelineLayout::processShaderBinary(ShaderBinary& binary)
{
