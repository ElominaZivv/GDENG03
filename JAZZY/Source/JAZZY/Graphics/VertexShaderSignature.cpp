...
jazzy::VertexShaderSignature::VertexShaderSignature(const VertexShaderSignatureDesc& desc, const GraphicsResourceDesc& gDesc):
...
jazzy::BinaryData jazzy::VertexShaderSignature::getShaderBinaryData() const noexcept
{
	return m_vsBinary->getData();
}

jazzy::BinaryData jazzy::VertexShaderSignature::getInputElementsData() const noexcept
{
	return
	{
		m_elements,
